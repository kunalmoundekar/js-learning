...
let nehaBtn =document.querySelector(".neha-Btn")

// nehaBtn.addEventListener("click",(e)=>{
//     e.preventDefault();


//     console.log("khihih");
//     localStorage.setItem("FavoriteItemsStorage", "Neha");
//     localStorage.setItem("FavoriteItemsStorage", "kunal");
//     localStorage.setItem("FavoriteItemsStorage", "Jayshri");
//     debugger;
//     var result = localStorage.getItem("FavoriteItemsStorage");
//     debugger;
